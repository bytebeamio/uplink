...
use protocol::{default_timeout, Action, ActionResponse, Package, Payload, DEFAULT_TIMEOUT};
...
mod tests {
    ...
    use crate::{Action, ActionResponse, ActionRoute, Config, StreamMetricsConfig};
