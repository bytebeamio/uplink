...
pub const MAX_STREAM_COUNT: usize = 1000;
...
fn default_clickhouse_username() -> String {
    std::env::var("CLICKHOUSE_USERNAME").expect("The env variable CLICKHOUSE_USERNAME is not set")
}

fn default_clickhouse_password() -> String {
    std::env::var("CLICKHOUSE_PASSWORD").expect("The env variable CLICKHOUSE_PASSWORD is not set")
}
