...
def update_firmware(action_id, payload_json):
    ...
    zip_file_path = payload['saved_path']
    print(zip_file_path)

    dest_path = "/home/pi/update_files"
    ...
    with zipfile.ZipFile(zip_file_path, 'r') as zip_file:
        ...
        print(root_path)
        script_path = "/home/pi/update_files/%s/update.sh"%root_path.name
        script_cwd = "/home/pi/update_files/%s"%root_path.name
		  print("script_path: " script_path)
		  print("script_cwd: " script_cwd)
